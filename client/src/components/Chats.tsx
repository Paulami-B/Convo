...
export default function Chats() {
  return (
    <div className="h-screen w-full p-4 bg-orange-50/40 dark:bg-black flex flex-col">
      <div className="top-0 h-fit sticky bg-[#FFFCF8] dark:bg-black z-50">
        ...
        <div className="flex items-center gap-2 bg-orange-50 dark:bg-orange-950 rounded-lg p-3">
